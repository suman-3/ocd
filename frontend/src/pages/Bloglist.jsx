...
// // function makeExcerpt(html = "", wordCount = 12) {
...
// //   if (loading) return <div className="py-16 text-center">Loading blogs…</div>;
...
// //         <h1 className="text-4xl font-bold uppercase tracking-wide">Blog List</h1>
// //       </div>

// //       {/* Content + Sidebar */}
      
// //       <div className="max-w-7xl mx-auto px-4 md:px-6 py-10 grid grid-cols-1 lg:grid-cols-[1fr_350px] gap-8 items-start">
// //         {/* Center column – blog cards */}
// //         <div className="space-y-10">
// //           {blogs.map((b) => (
// //             <article
// //               key={b.id}
// //               className="grid grid-cols-1 sm:grid-cols-2 gap-6 bg-gray-50 rounded-lg border border-gray-200 shadow-sm overflow-hidden"
// //             >
// //               {/* Left image */}
// //               <div className="h-[260px] sm:h-full">
// //                 <img
// //                   src={b.image1 || "https://via.placeholder.com/600x400?text=Blog+Image"}
// //                   alt={b.name}
...
// //                 <span className="inline-block bg-red-600 text-white text-[11px] font-semibold px-3 py-1 rounded uppercase inline-flex w-fit">
// //                   Body Shop
// //                 </span>

// //                 <Link to={`/blogs/${b.id}`}>
// //                   <h2 className="text-[22px] sm:text-[24px] font-bold uppercase leading-tight hover:text-red-600 transition-colors">
// //                     {b.name}
// //                   </h2>
// //                 </Link>

// //                 <p className="text-gray-600 mt-2">{makeExcerpt(b.rich_text1, 15)}</p>
...
// //                     })}
// //                   </span>
// //                   <span className="mx-4 inline-block w-1 h-1 rounded-full bg-gray-400" />
...
//               <div className="p-6 flex flex-col justify-center">
//                 <span className="inline-block bg-red-600 text-white text-[11px] font-semibold px-3 py-1 rounded uppercase w-fit">
//                   Body Shop
//                 </span>
...
// const API_BASE = import.meta.env.VITE_API_BASE || "http://localhost:4000";             # comented 
...
export default function BlogList() {
  ...
  <div className="mt-auto">
    ...
    <div className="flex items-center text-[13px] text-[#949087]">
      ...
      <span>
        {b.commentsCount ?? 0}{" "}
        {Number(b.commentsCount ?? 0) === 1 ? "Comment" : "Comments"}
      </span>
    </div>
  </div>
</div>
