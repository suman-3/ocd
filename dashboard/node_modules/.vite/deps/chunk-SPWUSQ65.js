...
var ButtonGroupContext = React14.createContext({});
if (true) {
...
var ButtonGroupButtonContext = React15.createContext(void 0);
if (true) {
...
var Button = React16.forwardRef(function Button2(inProps, ref) {
  const contextProps = React16.useContext(ButtonGroupContext_default);
  const buttonGroupButtonContextPositionClassName = React16.useContext(ButtonGroupButtonContext_default);
...
true ? Button.propTypes = {
   ...
   */
  loadingIndicator: import_prop_types13.default.node,
  /**
   * The loading indicator can be positioned on the start, end, or the center of the button.
   * @default 'center'
   */
  loadingPosition: import_prop_types13.default.oneOf(["center", "end", "start"]),
  /**
   * The size of the component.
...
//# sourceMappingURL=chunk-SPWUSQ65.js.map
